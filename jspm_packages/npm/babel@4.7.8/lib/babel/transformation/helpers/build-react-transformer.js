...
(function(process) {
  ...
  module.exports = function(exports, opts) {
    ...
    exports.JSXMemberExpression = {exit: function exit(node) {
    ...
    exports.JSXOpeningElement = {exit: function exit(node, parent, scope, file) {
    ...
    exports.JSXElement = {exit: function exit(node) {
