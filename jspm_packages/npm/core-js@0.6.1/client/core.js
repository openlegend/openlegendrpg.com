  ...
  !function(global, framework, undefined) {
    ...
    !function(_defineProperty, IS_ENUMERABLE, Empty, _classof, $PROTO) {
      if (!DESC) {
        var defineDOM = false;
        try {
          defineDOM = defineProperty(document.createElement('div'), 'x', {get: function() {
              return 8;
            }}).x == 8;
        } catch (e) {}
      ...
      $define(PROTO, DATE, {toISOString: function() {
          ...
          var d = this,
              ...
              s = y < 0 ? '-' : y > 9999 ? '+' : '';
          return s + ('00000' + abs(y)).slice(s ? -6 : -4) + '-' + lz(d.getUTCMonth() + 1) + '-' + lz(d.getUTCDate()) + 'T' + lz(d.getUTCHours()) + ':' + lz(d.getUTCMinutes()) + ':' + lz(d.getUTCSeconds()) + '.' + (m > 99 ? m : '0' + lz(m)) + 'Z';
        }});
