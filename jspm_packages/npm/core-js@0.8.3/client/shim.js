  ...
  !function(undefined) {
    ...
    (function e(t, n, r) {
      ...
      1: [function(require, module, exports) {
        ...
        "./es6.array.fill": 30,
        "./es6.array.find": 32,
        "./es6.array.find-index": 31,
        "./es6.array.from": 33,
        "./es6.array.iterator": 34,
        "./es6.array.of": 35,
        "./es6.array.species": 36,
        "./es6.function.name": 37,
        "./es6.map": 38,
        "./es6.math": 39,
        "./es6.number.constructor": 40,
        "./es6.number.statics": 41,
        "./es6.object.assign": 42,
        "./es6.object.is": 43,
        "./es6.object.set-prototype-of": 44,
        "./es6.object.statics-accept-primitives": 45,
        "./es6.object.to-string": 46,
        "./es6.promise": 47,
        "./es6.reflect": 48,
        "./es6.regexp": 49,
        "./es6.set": 50,
        "./es6.string.code-point-at": 51,
        "./es6.string.ends-with": 52,
        "./es6.string.from-code-point": 53,
        "./es6.string.includes": 54,
        "./es6.string.iterator": 55,
        "./es6.string.raw": 56,
        "./es6.string.repeat": 57,
        "./es6.string.starts-with": 58,
        "./es6.symbol": 59,
        "./es6.weak-map": 60,
        "./es6.weak-set": 61,
        "./es7.array.includes": 62,
        "./es7.object.get-own-property-descriptors": 63,
        "./es7.object.to-array": 64,
        "./es7.regexp.escape": 65,
        "./es7.set.to-json": 66,
        "./es7.string.at": 67,
        "./js.array.statics": 68,
        "./web.dom.iterable": 69,
