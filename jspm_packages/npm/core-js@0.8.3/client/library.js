  ...
  !function(undefined) {
    ...
    (function e(t, n, r) {
      ...
      1: [function(require, module, exports) {
        ...
        "./es6.reflect": 60,
        "./es6.set": 61,
        "./es6.string.code-point-at": 62,
        "./es6.string.ends-with": 63,
        "./es6.string.from-code-point": 64,
        "./es6.string.includes": 65,
        "./es6.string.iterator": 66,
        "./es6.string.raw": 67,
        "./es6.string.repeat": 68,
        "./es6.string.starts-with": 69,
        "./es6.symbol": 70,
        "./es6.weak-map": 71,
        "./es6.weak-set": 72,
        "./es7.array.includes": 73,
        "./es7.object.get-own-property-descriptors": 74,
        "./es7.object.to-array": 75,
        "./es7.regexp.escape": 76,
        "./es7.set.to-json": 77,
        "./es7.string.at": 78,
        "./js.array.statics": 79,
        "./web.dom.iterable": 80,
