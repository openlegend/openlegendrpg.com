...
System.register(["angular", "angular-mocks", "chai", "sinon", "sinon-chai", "./loginComponent.controller"], function (_export, _context) {
  "use strict";
    ...
    execute: function () {
      ...
      describe('controller: LoginComponentCtrl', function () {
        ...
        beforeEach(inject(function ($controller, _$rootScope_) {
          ...
          controller = $controller('LoginComponentCtrl', {
            $state: $state,
            $animate: $animate,
            Auth: Auth
          });
...
//# sourceMappingURL=loginComponent.controller.spec.js.map
