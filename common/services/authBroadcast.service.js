...
System.register(["angular"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      authBroadcastModule = angular.module('authBroadcast.service.js', []); // auth events that we catch and use to broadcast user access control
...
//# sourceMappingURL=authBroadcast.service.js.map
