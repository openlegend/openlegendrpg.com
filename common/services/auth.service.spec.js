System.register(["angular", "angular-mocks", "chai", "sinon", "sinon-chai", "./auth.service"], function (_export) {
    ...
    execute: function () {
      ...
      describe("service: Auth", function () {
        ...
        describe("login method", function () {
          it("posts to apiBase at '/api/auth/login'", function () {
            $httpBackend.expectPOST(URL.apiBase + "/api/auth/login").respond(postData);
            Auth.login(userInfo);
            verifyBackend();
          });
          ...
          describe("on successful POST", function () {
            it("calls callback with no arguments", function () {
              ...
              $httpBackend.whenPOST(URL.apiBase + "/api/auth/login").respond(postData);
            ...
            it("adds the token to the $cookieStore", function (done) {
              var token = "123abc";
              $httpBackend.whenPOST(URL.apiBase + "/api/auth/login").respond({ token: token });
          ...
          describe("on failed POST", function () {
            it("calls Auth.logout()", function () {
              $httpBackend.whenPOST(URL.apiBase + "/api/auth/login").respond(400, anError);
...
//# sourceMappingURL=../../common/services/auth.service.spec.js.map