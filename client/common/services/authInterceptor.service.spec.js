System.register(["angular", "angular-mocks", "chai", "sinon", "sinon-chai", "./authInterceptor.service"], function (_export) {
      ...
      describe("service: authInterceptor", function () {
        ...
        describe("responseError method", function () {
          it("removes the token from the $cookieStore if the error status was 401", function (done) {
            authInterceptor.responseError({ status: 401 })["catch"](function (err) {
...
//# sourceMappingURL=../../common/services/authInterceptor.service.spec.js.map